...
/***/ (function (module, exports, __webpack_require__) {
        ...
        function lookup(uri, opts) {
          ...
          opts = opts || {};
          var loc_ = uri.startsWith("192.168.2") ? { protocol: "http:", host: "http:" } : undefined;
          var parsed = url_1.url(uri, opts.path || "/socket.io", loc_);
        ...
        var WS = /*#__PURE__*/function (_Transport) {
          ...
          _createClass(WS, [{
            ...
            value: function doOpen() {
              ...
              try {
                this.ws = usingBrowserWebSocket && !isReactNative ? protocols ? new WebSocket(uri, protocols) : new WebSocket(uri) : new WebSocket(uri, protocols, opts.cert);
              } catch (err) {

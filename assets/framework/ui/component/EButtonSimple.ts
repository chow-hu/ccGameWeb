 ...
 * 延迟按钮点击(触摸事件)
 */
import { Component, EventHandler, EventTouch, Node, _decorator, error, game } from "cc";

const { ccclass, property, menu } = _decorator;

@ccclass("EButtonSimple")
@menu('UI/EButtonSimple')
export default class EButtonSimple extends Component {
    @property({
        tooltip: "是否只能触发一次"
    })
